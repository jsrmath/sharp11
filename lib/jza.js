...
JzA.prototype.findFailurePoint = function (symbols) {
  ...
  var getReturnValue = function (index, previousStates, invalidEndState) {
    return {
      ...
      previousSymbol: symbols[index - 1],
      nextSymbol: symbols[index + 1],
      index: index,
...
// Allow chords to be set up with V or ii-V
var addElaboration = function (jza) {
  // Exclude I because ii-V-I of I is not considered elaborational
