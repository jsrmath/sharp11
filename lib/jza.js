...
var addSpecialCadences = function (jza) {
  // Packed subtonic cadence (iv-I)
  var ivState = jza.addState('Packed subtonic cadence', true);
  ivState.addSource(symbolFromMehegan('IVm'), jza.getStateByName('Subdominant'));
  ivState.addTransition(symbolFromMehegan('I'), jza.getStateByName('Tonic'));
};
