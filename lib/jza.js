...
// Sums the counts of all its transitions
JzState.prototype.getTotalCount = function () {
  return _.reduce(this.transitions, function (total, t) {
...
JzState.prototype.getTransitionsWithProbabilities = function () {
  ...
  return _.map(this.transitions, function (t) {
    return {
      transition: t,
...
JzState.prototype.getTransitionByProbability = function () {
  var transitions = this.getTransitionsWithProbabilities();
  var probTotal = 0;
...
JzA.prototype.getPathways = function (symbols) {
  ...
  _.each(_.rest(symbols), function (symbol) {
    ...
    var transitions = _.flatten(_.map(lastStates, function (state) {
  ...
  var removeDeadEnd = function (timeStep, nextTimeStep) {
  ...
  for (i = pathways.length - 2; i >= 0; i -= 1) {
    pathways[i] = removeDeadEnd(pathways[i], pathways[i + 1]);
  }
...
// Return the total probability of a sequence of symbols
JzA.prototype.getProbability = function (symbols) {
