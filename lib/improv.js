...
var Improv = function (settings) {
  var defaultSettings = {
    ...
    changeDir: 0.5, // Likelihood of changing chromatic direction, number (0 to 1) or range
    jumpiness: 0.5, // Likelihood of jumping intervals, number (0 to 1) or range
    rests: [0.75, 0], // Likelihood of a note being a rest (previous note is sustained), number (0 to 1) or range
...
var ImprovChart = function (chart) {
  ...
  this.midi = function (filename, options) {
    return midi.output('improvChart', this, filename, options);
  };
